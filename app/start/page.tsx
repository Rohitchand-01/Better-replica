      ...
      <main className={styles.main}>
        ...
        <div className={styles.avatar}>
          <div className={styles.avatarImage}>
            <House className={styles.avatarIcon} />
          </div>
        </div>
        ...
        <div className={styles.benefits}>
          ...
          <div className={styles.benefitsList}>
            ...
            <div className={styles.benefit}>
              <span className={styles.benefitIcon}>
                <svg
                  className='MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-1ivbj1-MuiSvgIcon-root'
                  focusable='false'
                  aria-hidden='true'
                  viewBox='0 0 24 24'
        ...
        <div className={styles.footerContent}>
          ...
          <div className={styles.footerSection}>
            ...
            <ul className={styles.footerLinks}>
              <li><a href="#" className={styles.footerLink}>Schedule a conversation</a></li>
              <li><a href="mailto:hello@better.com" className={styles.footerLink}>hello@better.com</a></li>
              <li><a href="tel:415-523-8837" className={styles.footerLink}>415-523-8837</a></li>
              <li><a href="#" className={styles.footerLink}>FAQ</a></li>
              <li><a href="#" className={styles.footerLink}>Resources</a></li>
            </ul>
          </div>
          ...
          <div className={styles.footerSection}>
            ...
            <ul className={styles.footerLinks}>
              <li><a href="#" className={styles.footerLink}>NMLS Consumer Access</a></li>
              <li><a href="#" className={styles.footerLink}>Privacy Policy</a></li>
              <li><a href="#" className={styles.footerLink}>Terms of Use</a></li>
              <li><a href="#" className={styles.footerLink}>Disclosures & Licensing</a></li>
              <li><a href="#" className={styles.footerLink}>Affiliated Business</a></li>
            </ul>
